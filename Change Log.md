...
### Android（問題所在）
因為每個裝置的生產商都不一樣，標準也都不一樣，內建的觸控獲得的半徑也不一定是正確的。

我原本的想法是，可以用螢幕的DPI來反推回來觸控的大小。想法是這樣：
...
### 玩家自訂觸控範圍
增加觸控範圍有好處，但也意味著可能會誤觸其他軌道，所以變成玩家可以自訂（小，中，大）

## 滑動
滑動音符的滑動動作偵測變成可自訂（低，中，高）

## 音符顏色，判定顏色
我會提醒玩家「我們不建議調顏色，但是如果您有需求，可以在此設定音符跟判定的顏色」
