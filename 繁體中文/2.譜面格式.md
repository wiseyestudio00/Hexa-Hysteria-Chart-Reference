...
- [舞台行動](#----)
  ...
  * [更換顏色](#----)
    ...
    + [種類](#--)
      - [Text 文字](#text---)
      - [UIBackground 使用者背景](#uibackground------)
      - [Note 音符](#note---)
      - [Trial 軌道](#trial---)
      - [Trial_Pattern 軌道上緩緩移動的六角形](#trial-pattern------------)
      - [Hitbox_default（打擊器，沒有被按住的顏色）](#hitbox-default--------------)
      - [HitBox_pressed（打擊器，被按住時的眼色）](#hitbox-pressed-------------)
    + [顏色格式](#----)
      - [例](#-)
    + [示範](#---2)
    + [解說](#---1)
  ...
  * [重組舞台](#----)
    ...
    + [示範](#---6)
    + [解說](#---2)
      - [1. 為什麼旋轉舞台時不也直接用重組舞台行動就好了？為什麼要轉攝影機？](#1---------------------------------)
      - [2. 重組舞台時，可以保證所有的螢幕都能看到軌道嗎？（也就是說，平板或是手機都能看到同樣的效果？）](#2-----------------------------------------------)
      - [3. 重組的途中，可以正常打擊嗎？](#3---------------)
- [註釋](#--)
    + [禁止的案例](#-----)
- [尚未寫出的舞台行動](#---------)
