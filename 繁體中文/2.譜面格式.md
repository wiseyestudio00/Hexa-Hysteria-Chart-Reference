...
# 暫停
```
a stopbeat note/action 100 1
```
暫停音符及行動一拍，從101拍繼續開始
（這會製造類似瞬移的效果，音符會在100拍停止一拍，然後瞬移到他們101應該要在的位置）

這是一個很特殊的舞台行動，所以這邊特別講解一下
- 「暫停」並不是指「暫停數拍子」，而是「暫停所有的音符跟舞台行動」，拍子還是正在被數著，所以才能造成「瞬移」的效果
- 在這「暫停」的期間，音符依然可以被打到
- 音樂會繼續播放

# 加拍子
```
a addbeat 99 1 100-104 3 easeinoutsine
```
在第99拍的時候，花一拍的時間，把在第100到104拍發生的音符/舞台行動的開始拍+3拍
這可以導致類似「倒退」的效果
